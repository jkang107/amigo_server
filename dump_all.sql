...
CREATE TABLE `users` (
  ...
  `kakaoThumb` varchar(200) NOT NULL,
...
INSERT INTO `users` VALUES (22044723,'강진아','http://mud-kage.kakao.co.kr/14/dn/btqb4CAgAzI/RQ6IGbda4CN2krpdNJ5aOk/o.jpg',NULL);
...
-- Dump completed on 2015-05-25 14:25:14
